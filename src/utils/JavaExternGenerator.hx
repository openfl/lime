...
class JavaExternGenerator
{
	...
	public function new(config:NMEProject, javaPath:String, externPath:String)
	{
		this.config = config;
	...
	private function parse(src:Input, inMembers:Map<String, String>)
	{
		...
		if (java_out != null)
		{
			...
			var nme_path = getHaxelib("openfl-native") + "/templates/android/template/src";
