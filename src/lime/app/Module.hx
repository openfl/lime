...
class Module implements IModule {
	...
	@:noCompletion public function addWindow (window:Window):Void {
		...
		window.onRenderContextLost.add (onRenderContextLost.bind (window));
		window.onRenderContextRestored.add (onRenderContextRestored.bind (window));
	 ...
	 * @param	window	The window dispatching the event
	 */
	public function onRenderContextLost (window:Window):Void { }
	 ...
	 */
	public function onRenderContextRestored (window:Window, context:RenderContext):Void { }
	 ...
	 */
	public function render (window:Window, context:RenderContext):Void { }
