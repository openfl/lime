...
class Rectangle {
	...
	**/
	...
	@:noCompletion private function get_bottomRight ():Vector2 { return new Vector2 (x + width, y + height); }
	@:noCompletion private function set_bottomRight (p:Vector2):Vector2 { width = p.x - x; height = p.y - y; return p.clone (); }
	...
	@:noCompletion private function get_size ():Vector2 { return new Vector2 (width, height); }
	@:noCompletion private function set_size (p:Vector2):Vector2 { width = p.x; height = p.y; return p.clone (); }
	...
	@:noCompletion private function get_topLeft ():Vector2 { return new Vector2 (x, y); }
	@:noCompletion private function set_topLeft (p:Vector2):Vector2 { x = p.x; y = p.y; return p.clone (); }
