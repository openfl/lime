...
class Assets {
	 ...
	 * @return		A new BItmapData object
		...
		if (AssetData.type.exists(id) && AssetData.type.get(id) == IMAGE) {
			...
			if (AssetData.library.exists(libraryName)) {
				...
				trace("[lime.utils.Assets] There is no asset library named \"" + libraryName + "\"");
				
			}
			
		} else {
			
			trace("[lime.utils.Assets] There is no BitmapData asset with an ID of \"" + id + "\"");
	...
	public static function getFont(id:String):Font {
		...
		if (AssetData.type.exists(id) && AssetData.type.get(id) == FONT) {
			...
			trace("[lime.utils.Assets] There is no Font asset with an ID of \"" + id + "\"");
	...
	public static function getSound(id:String):Sound {
		...
		trace("[lime.utils.Assets] There is no Sound asset with an ID of \"" + id + "\"");
