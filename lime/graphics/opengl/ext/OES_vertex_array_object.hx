...
class OES_vertex_array_object {
	...
	public function createVertexArrayOES ():Dynamic { return null;  } /*WebGLVertexArrayObject*/
	public function deleteVertexArrayOES (arrayObject:Dynamic /*WebGLVertexArrayObject*/):Void {}
	public function isVertexArrayOES (arrayObject:Dynamic /*WebGLVertexArrayObject*/):Bool { return false; }
