...
abstract WebGLRenderContext(WebGL2RenderContext) from GLRenderContext from WebGL2RenderContext {
	...
	@:from private static function fromGL (gl:#if lime_opengl Class<GL> #else Dynamic #end):WebGLRenderContext {
	...
	@:from private static function fromGLES2Context (gl:GLES2RenderContext):WebGLRenderContext {
	...
	@:from private static function fromGLES3Context (gl:GLES3RenderContext):WebGLRenderContext {
