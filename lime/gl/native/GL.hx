...
class GL {
    ...
    public static function bindAttribLocation(program:GLProgram, index:Int, name:String):Void 
    {
        ...
        //note : This is flash api specific for nme/openfl and is not required for lime,
        //but we can shield it out, except lime_native will be defined at all times
        //so we need a cleaner way
    ...
    public static function uniform1fv(location:GLUniformLocation, x:LimeFloats):Void 
    {
    ...
    public static function uniform2fv(location:GLUniformLocation, v:LimeFloats):Void 
    {
    ...
    public static function uniform3fv(location:GLUniformLocation, v:LimeFloats):Void 
    {
    ...
    public static function uniform4fv(location:GLUniformLocation, v:LimeFloats):Void 
    {
    ...
    public static function vertexAttrib1fv(indx:Int, values:LimeFloats):Void 
    {
    ...
    public static function vertexAttrib2fv(indx:Int, values:LimeFloats):Void 
    {
    ...
    public static function vertexAttrib3fv(indx:Int, values:LimeFloats):Void 
    {
    ...
    public static function vertexAttrib4fv(indx:Int, values:LimeFloats):Void 
    {
