...
class NativeCFFI {
	...
	@:cffi private static function lime_gl_create_buffer ():GLBuffer;
	@:cffi private static function lime_gl_create_framebuffer ():GLFramebuffer;
	@:cffi private static function lime_gl_create_program ():GLProgram;
	@:cffi private static function lime_gl_create_renderbuffer ():GLRenderbuffer;
	@:cffi private static function lime_gl_create_shader (type:Int):GLShader;
	@:cffi private static function lime_gl_create_texture ():GLTexture;
	...
	@:cffi private static function lime_gl_get_program_parameter (program:GLProgram, pname:Int):Dynamic;
	@:cffi private static function lime_gl_get_renderbuffer_parameter (target:Int, pname:Int):Dynamic;
	@:cffi private static function lime_gl_get_shader_info_log (shader:GLShader):Dynamic;
	@:cffi private static function lime_gl_get_shader_parameter (shader:GLShader, pname:Int):Dynamic;
	...
	@:cffi private static function lime_gl_get_uniform (program:GLProgram, location:Int):Dynamic;
	...
	@:cffi private static function lime_gl_object_constructor (type:Int, constructor:Dynamic):Void;
