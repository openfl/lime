...
class NativeCFFI {
	...
	@:cffi private static function lime_gl_attach_shader (program:GLProgram, shader:GLShader):Void;
	@:cffi private static function lime_gl_bind_attrib_location (program:GLProgram, index:Int, name:String):Void;
	@:cffi private static function lime_gl_bind_buffer (target:Int, buffer:GLBuffer):Void;
	@:cffi private static function lime_gl_bind_framebuffer (target:Int, framebuffer:GLFramebuffer):Void;
	@:cffi private static function lime_gl_bind_renderbuffer (target:Int, renderbuffer:GLRenderbuffer):Void;
	@:cffi private static function lime_gl_bind_texture (target:Int, texture:GLTexture):Void;
	...
	@:cffi private static function lime_gl_compile_shader (shader:GLShader):Void;
	...
	@:cffi private static function lime_gl_create_buffer ():Dynamic;
	@:cffi private static function lime_gl_create_framebuffer ():Dynamic;
	@:cffi private static function lime_gl_create_program ():Dynamic;
	@:cffi private static function lime_gl_create_renderbuffer ():Dynamic;
	@:cffi private static function lime_gl_create_shader (type:Int):Dynamic;
	@:cffi private static function lime_gl_create_texture ():Dynamic;
	@:cffi private static function lime_gl_cull_face (mode:Int):Void;
	@:cffi private static function lime_gl_delete_buffer (buffer:GLBuffer):Void;
	@:cffi private static function lime_gl_delete_framebuffer (framebuffer:GLFramebuffer):Void;
	@:cffi private static function lime_gl_delete_program (program:GLProgram):Void;
	@:cffi private static function lime_gl_delete_renderbuffer (renderbuffer:GLRenderbuffer):Void;
	@:cffi private static function lime_gl_delete_shader (shader:GLShader):Void;
	@:cffi private static function lime_gl_delete_texture (texture:GLTexture):Void;
	...
	@:cffi private static function lime_gl_detach_shader (program:GLProgram, shader:GLShader):Void;
	...
	@:cffi private static function lime_gl_framebuffer_renderbuffer (target:Int, attachment:Int, renderbuffertarget:Int, renderbuffer:GLRenderbuffer):Void;
	@:cffi private static function lime_gl_framebuffer_texture2D (target:Int, attachment:Int, textarget:Int, texture:GLTexture, level:Int):Void;
	...
	@:cffi private static function lime_gl_get_active_attrib (program:GLProgram, index:Int):Dynamic;
	@:cffi private static function lime_gl_get_active_uniform (program:GLProgram, index:Int):Dynamic;
	@:cffi private static function lime_gl_get_attached_shaders (program:GLProgram):Dynamic;
	@:cffi private static function lime_gl_get_attrib_location (program:GLProgram, name:String):Int;
	...
	@:cffi private static function lime_gl_get_program_info_log (program:GLProgram):Dynamic;
	@:cffi private static function lime_gl_get_programi (program:GLProgram, pname:Int):Int;
	@:cffi private static function lime_gl_get_programiv (program:GLProgram, pname:Int, params:DataPointer):Void;
	...
	@:cffi private static function lime_gl_get_shader_info_log (shader:GLShader):Dynamic;
	@:cffi private static function lime_gl_get_shaderi (shader:GLShader, pname:Int):Int;
	@:cffi private static function lime_gl_get_shaderiv (shader:GLShader, pname:Int, params:DataPointer):Void;
	@:cffi private static function lime_gl_get_shader_precision_format (shadertype:Int, precisiontype:Int):Dynamic;
	@:cffi private static function lime_gl_get_shader_source (shader:GLShader):Dynamic;
	...
	@:cffi private static function lime_gl_get_uniformf (program:GLProgram, location:Int):Float32;
	@:cffi private static function lime_gl_get_uniformfv (program:GLProgram, location:Int, params:DataPointer):Void;
	@:cffi private static function lime_gl_get_uniformi (program:GLProgram, location:Int):Int;
	@:cffi private static function lime_gl_get_uniformiv (program:GLProgram, location:Int, params:DataPointer):Void;
	@:cffi private static function lime_gl_get_uniform_location (program:GLProgram, name:String):Int;
	...
	@:cffi private static function lime_gl_is_buffer (buffer:GLBuffer):Bool;
	@:cffi private static function lime_gl_is_enabled (cap:Int):Bool;
	@:cffi private static function lime_gl_is_framebuffer (framebuffer:GLFramebuffer):Bool;
	@:cffi private static function lime_gl_is_program (program:GLProgram):Bool;
	@:cffi private static function lime_gl_is_renderbuffer (renderbuffer:GLRenderbuffer):Bool;
	@:cffi private static function lime_gl_is_shader (shader:GLShader):Bool;
	@:cffi private static function lime_gl_is_texture (texture:GLTexture):Bool;
	@:cffi private static function lime_gl_line_width (width:Float32):Void;
	@:cffi private static function lime_gl_link_program (program:GLProgram):Void;
	@:cffi private static function lime_gl_object_constructor (constructor:Dynamic):Void;
	@:cffi private static function lime_gl_object_from_id (type:Int, id:Int):Dynamic;
	...
	@:cffi private static function lime_gl_shader_source (shader:GLShader, source:String):Void;
	...
	@:cffi private static function lime_gl_use_program (program:GLProgram):Void;
	@:cffi private static function lime_gl_validate_program (program:GLProgram):Void;
