...
class NativeCFFI {
	...
	@:cffi private static function lime_gl_client_wait_sync (sync:CFFIPointer, flags:Int, timeoutA:Int, timeoutB:Int):Void;
	...
	@:cffi private static function lime_gl_create_sync ():CFFIPointer;
	...
	@:cffi private static function lime_gl_get_internal_formativ (target:Int, internalformat:Int, pname:Int, bufSize:Int, params:DataPointer):Void;
	...
	@:cffi private static function lime_gl_get_query_objecti (target:Int, pname:Int):Int;
	@:cffi private static function lime_gl_get_query_objectiv (target:Int, pname:Int, params:DataPointer):Void;
	...
	@:cffi private static function lime_gl_map_buffer_range (target:Int, offset:DataPointer, length:Int, access:Int):Void;
