...
namespace lime {
	...
	void lime_gl_attach_shader (value program, value shader) {
		...
		glAttachShader ((GLuint)val_data (program), (GLuint)val_data (shader));
	...
	void lime_gl_bind_attrib_location (value handle, int inSlot, HxString inName) {
		...
		glBindAttribLocation ((GLuint)val_data (handle), inSlot, inName.__s);
	...
	void lime_gl_bind_buffer (int target, value buffer) {
		...
		glBindBuffer (target, val_is_null (buffer) ? 0 : (GLuint)val_data (buffer));
	...
	void lime_gl_bind_framebuffer (int target, value framebuffer) {
		...
		glBindFramebuffer (target, val_is_null (framebuffer) ? 0 : (GLuint)val_data (framebuffer));
	...
	void lime_gl_bind_renderbuffer (int target, value renderbuffer) {
		...
		glBindRenderbuffer (target, val_is_null (renderbuffer) ? 0 : (GLuint)val_data (renderbuffer));
	...
	void lime_gl_bind_texture (int target, value texture) {
		...
		glBindTexture (target, val_is_null (texture) ? 0 : (GLuint)val_data (texture));
	...
	void lime_gl_compile_shader (value handle) {
		...
		glCompileShader ((GLuint)val_data (handle));
	...
	void lime_gl_detach_shader (value program, value shader) {
		...
		glDetachShader ((GLuint)val_data (program), (GLuint)val_data (shader));
	...
	void lime_gl_framebuffer_renderbuffer (int target, int attachment, int renderbuffertarget, value renderbuffer) {
		...
		glFramebufferRenderbuffer (target, attachment, renderbuffertarget, (GLuint)val_data (renderbuffer));
	...
	void lime_gl_framebuffer_texture2D (int target, int attachment, int textarget, value texture, int level) {
		...
		glFramebufferTexture2D (target, attachment, textarget, (GLuint)val_data (texture), level);
	...
	value lime_gl_get_active_attrib (value handle, int inIndex) {
		...
		glGetActiveAttrib ((GLuint)val_data (handle), inIndex, 1024, &outLen, &size, &type, buf);
	...
	value lime_gl_get_active_uniform (value handle, int inIndex) {
		...
		glGetActiveUniform ((GLuint)val_data (handle), inIndex, 1024, &outLen, &size, &type, buf);
	...
	int lime_gl_get_attrib_location (value handle, HxString inName) {
		...
		return glGetAttribLocation ((GLuint)val_data (handle), inName.__s);
	...
	HxString lime_gl_get_program_info_log (value handle) {
		...
		char buf[1024];
		glGetProgramInfoLog ((GLuint)val_data (handle), 1024, 0, buf);
		return HxString (buf);
	...
	int lime_gl_get_program_parameter (value handle, int inName) {
		...
		int result = 0;
		glGetProgramiv ((GLuint)val_data (handle), inName, &result);
		return result;
	...
	HxString lime_gl_get_shader_info_log (value handle) {
		...
		glGetShaderInfoLog ((GLuint)val_data (handle), 1024, 0, buf);
	...
	int lime_gl_get_shader_parameter (value handle, int inName) {
		...
		int result = 0;
		glGetShaderiv ((GLuint)val_data (handle), inName, &result);
		return result;
	...
	value lime_gl_get_shader_source (value handle) {
		...
		int len = 0;
		glGetShaderiv ((GLuint)val_data (handle), GL_SHADER_SOURCE_LENGTH, &len);
		...
		glGetShaderSource ((GLuint)val_data (handle), len + 1, 0, buf);
	...
	int lime_gl_get_uniform_location (value handle, HxString inName) {
		...
		return glGetUniformLocation ((GLuint)val_data (handle), inName.__s);
	...
	bool lime_gl_is_buffer (value handle) {
		...
		return glIsBuffer ((GLuint)val_data (handle));
	...
	bool lime_gl_is_framebuffer (value handle) {
		...
		return glIsFramebuffer ((GLuint)val_data (handle));
	...
	bool lime_gl_is_program (value handle) {
		...
		return glIsProgram ((GLuint)val_data (handle));
	...
	bool lime_gl_is_renderbuffer (value handle) {
		...
		return glIsRenderbuffer ((GLuint)val_data (handle));
	...
	bool lime_gl_is_shader (value handle) {
		...
		return glIsShader ((GLuint)val_data (handle));
	...
	bool lime_gl_is_texture (value handle) {
		...
		return glIsTexture ((GLuint)val_data (handle));
	...
	void lime_gl_link_program (value handle) {
		...
		glLinkProgram ((GLuint)val_data (handle));
	...
	void lime_gl_shader_source (value handle, HxString source) {
		...
		glShaderSource ((GLuint)val_data (handle), 1, &source.__s, 0);
	...
	void lime_gl_use_program (value handle) {
		...
		glUseProgram (val_is_null (handle) ? 0 : (GLuint)val_data (handle));
	...
	void lime_gl_validate_program (value handle) {
		...
		glValidateProgram ((GLuint)val_data (handle));
