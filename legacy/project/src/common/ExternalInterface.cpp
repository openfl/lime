...
TEXT_PROP(caret_color,CaretColor,alloc_int,val_int);
TEXT_PROP(highlighted_text_color,HighlightedTextColor,alloc_int,val_int);
...
TEXT_PROP(highlight_color,HighlightColor,alloc_int,val_int);
